...
UNKNOWN_STREAMING_TITLE = str(os.getenv("UNKNOWN_STREAMING_TITLE"))
UNKNOWN_STREAMER_ID = int(os.getenv("UNKNOWN_STREAMER_ID", 0))
UNKNOWN_STREAMER_NAME = str(os.getenv("UNKNOWN_STREAMER_NAME"))
UNKNOWN_CHANNEL_ID = int(os.getenv("UNKNOWN_CHANNEL_ID", 0))
UNKNOWN_CHANNEL_NAME = str(os.getenv("UNKNOWN_CHANNEL_NAME"))
UNKNOWN_COMPANY_NAME = str(os.getenv("UNKNOWN_COMPANY_NAME"))
